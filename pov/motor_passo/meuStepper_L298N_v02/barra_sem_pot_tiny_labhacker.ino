//Barra sem pot em ATTiny85. Mensagem: LABHacker. 
//Usar ATTiny85 em 8MHz. 8MHz exige maior voltagem, a imagem fica com menos contraste
//                       Em compensacao, em 1MHz, a imagem nao troca rapido o suficiente
...
void loop() {
  ...
  int micro_pausa = 80; //15 funciona em 1MHz. Em 8MHz, 80 fica bom.
